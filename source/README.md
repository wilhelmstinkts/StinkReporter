# php-base - PHP Slim 4 Server library for Stink Reporter
...
------------ | ------------- | ------------- | -------------
*AbstractMessageApi* | **getMessages** | **GET** /message | 
*AbstractMessageApi* | **postNewMessage** | **POST** /message | 
*AbstractPlayApi* | **play** | **GET** /play | Make a game


## Models

* OpenAPIServer\Model\Choices
* OpenAPIServer\Model\GameResult
* OpenAPIServer\Model\Message
