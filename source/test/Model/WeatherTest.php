...
use OpenAPIServer\Model\Weather;
 ...
 * @link    https://github.com/openapitools/openapi-generator
 *
 * @coversDefaultClass \OpenAPIServer\Model\Weather
 */
class WeatherTest extends TestCase
{
    ...
    {
        $schemaObject = Weather::getOpenApiSchema();
        $schemaArr = Weather::getOpenApiSchema(true);
