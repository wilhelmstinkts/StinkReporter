...
class MailServiceTest extends TestCase
{
    ...
    public function testFormatTimeFrame()
    {
        $startTime = \DateTime::createFromFormat(\DateTimeInterface::ISO8601, '2020-03-10T12:00:00Z', new \DateTimeZone('UTC'));
        $endTime = \DateTime::createFromFormat(\DateTimeInterface::ISO8601, '2020-03-10T13:00:00Z', new \DateTimeZone('UTC'));
        ...
        $temperature = 20.45 + 273.15;
        $weather = new \OpenAPIServer\DTOs\Weather($temperature, $wind);
        $report = \OpenAPIServer\DTOs\Report::createWithTimeFrame($location, $timeFrame, $stink, $weather, $reporter);
